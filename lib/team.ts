...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    years: {
      en: "13+ years in project management & legal",
      ru: "13+ лет в управлении проектами и праве",
      ar: "أكثر من 13 عامًا في إدارة المشاريع والقانون",
      kk: "жоба басқару мен құқық саласында 13+ жыл",
    },
    bio: {
      en: "Project manager at NSART, leading a portfolio of parallel IT ventures from early idea to MVP and product-market fit — turning raw hypotheses into roadmaps, backlogs, and sprint plans for cross-functional teams. He owns budgeting, unit economics, and key metrics (NPS, retention, CAC, LTV), and builds distributed teams and transparent Agile/Scrum/Kanban processes from scratch. With a legal background (Master's in law) and 13+ years across project management, procurement, tenders, and contract work, he brings structure and risk discipline to a fast-moving venture environment.",
      ru: "Руководитель проектов в NSART: ведёт портфель параллельных IT-проектов от идеи до MVP и product-market fit — превращает «сырые» гипотезы в дорожные карты, бэклоги и планы спринтов для кросс-функциональных команд. Отвечает за бюджетирование, юнит-экономику и ключевые метрики (NPS, Retention, CAC, LTV), формирует распределённые команды и выстраивает прозрачные Agile/Scrum/Kanban-процессы с нуля. Юрист по образованию (магистр права) с 13+ годами опыта в управлении проектами, закупках, тендерах и договорной работе — привносит структуру и дисциплину рисков в динамичную венчурную среду.",
      ar: "مدير مشاريع في NSART، يقود محفظة من المشاريع التقنية المتوازية من الفكرة إلى MVP وملاءمة المنتج للسوق — محوّلًا الفرضيات الأولية إلى خرائط طريق وقوائم مهام وخطط سباقات لفرق متعددة الوظائف. يتولّى إعداد الموازنات واقتصاد الوحدة والمقاييس الرئيسية (NPS، Retention، CAC، LTV)، ويبني فرقًا موزّعة ويؤسس عمليات Agile/Scrum/Kanban شفافة من الصفر. بخلفية قانونية (ماجستير في القانون) وخبرة تتجاوز 13 عامًا في إدارة المشاريع والمشتريات والمناقصات والعقود، يضيف البنية وانضباط إدارة المخاطر إلى بيئة ريادية سريعة الإيقاع.",
      kk: "NSART компаниясындағы жоба жетекшісі: параллель IT-жобалар портфелін идеядан бастап MVP мен product-market fit кезеңіне дейін жүргізеді — «шикі» гипотезаларды кросс-функционалды командаларға арналған жол карталарына, бэклогтарға және спринт жоспарларына айналдырады. Бюджеттеу, юнит-экономика және негізгі метрикаларға (NPS, Retention, CAC, LTV) жауап береді, таратылған командалар құрып, Agile/Scrum/Kanban процестерін нөлден бастап ашық түрде орнатады. Заңгер мамандығы (құқық магистрі) және жоба басқару, сатып алу, тендер мен келісімшарт жұмысында 13 жылдан астам тәжірибесі бар — динамикалық венчурлық ортаға құрылым мен тәуекел тәртібін әкеледі.",
    },
    skills: {
      en: [
      ...
      ru: [
        ...
        "Agile / Scrum / Kanban",
        "Дорожные карты и бэклоги",
        "Юнит-экономика и метрики",
        "Тендеры и закупки",
        "Право и договоры",
      ],
      ar: [
        "إدارة المشاريع والمحافظ",
        "Agile / Scrum / Kanban",
        "خرائط الطريق وقوائم المهام",
        "اقتصاد الوحدة والمقاييس",
        "المناقصات والمشتريات",
        "القانون والعقود",
      ],
      kk: [
        "Жоба және портфельді басқару",
        "Agile / Scrum / Kanban",
        "Жол карталары мен бэклогтар",
        "Юнит-экономика және метрикалар",
        "Тендерлер мен сатып алу",
        "Құқық және келісімшарттар",
      ],
    },
  },
  {
