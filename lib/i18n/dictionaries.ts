...
const en = {
  ...
  contactPage: {
    ...
    formIndustry: "Your industry",
    formInterest: "Your request",
...
const ru: Dictionary = {
  ...
  contactPage: {
    ...
    formIndustry: "Ваша отрасль",
    formInterest: "Ваш запрос",
...
const kk: DeepPartial<Dictionary> = {
  ...
  contactPage: {
    ...
    formIndustry: "Сіздің салаңыз",
    formInterest: "Сұранысыңыз",
